...
class ReportRazaView extends StatefulWidget {
  @override
  State<ReportRazaView> createState() => _ReportRazaViewState();
}

class _ReportRazaViewState extends State<ReportRazaView> {
  ...
  Future<List<Map<String, dynamic>>> getData(BuildContext context) async {
    final result =
        await Injector.of(context).coreRepository.getDataRazaReport();
    return result;
  }
